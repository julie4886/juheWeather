...
public class MainActivity extends Activity {
	...
	private TextView felt_temp, // 体感温度
			...
			future_two,
			future_three, // 未来
			temp_future_one, temp_future_two,
			temp_future_three,
			weather_future_one, weather_future_two,
			weather_future_three,
			weather_hour_three, weather_hour_nine,
			weather_hour_six,
			weather_hour_tewle, weather_hour_fifty;

	private ImageView icon_hour_three, icon_hour_six, icon_hour_nine,
			icon_hour_tewle, icon_hour_fifty, icon_future_one, icon_future_two,
			icon_future_three;
	...
	private void init() {
		tv = (TextView) findViewById(R.id.tv_city); // 选择城市
	...
	private void setWeatherView(WeatherBean weatherBean) {
		...
		weather_id.setImageResource(getResources().getIdentifier(
				"d" + weatherBean.getWeather_id(), "drawable",
				"com.juhe.juheweather"));
		weather.setText(weatherBean.getWeather_str());
		...
		weather_future_one
				.setText(weatherBean.getFutureList().get(0).getTemp());
		temp_future_one.setText(weatherBean.getFutureList().get(0).getDate());
		icon_future_one.setImageResource(getResources().getIdentifier(
				"d" + weatherBean.getFutureList().get(0).getWeather_id(),
				"drawable", "com.juhe.juheweather"));

		future_two.setText(weatherBean.getFutureList().get(1).getWeek());
		weather_future_two
				.setText(weatherBean.getFutureList().get(1).getTemp());
		temp_future_two.setText(weatherBean.getFutureList().get(01).getDate());
		icon_future_two.setImageResource(getResources().getIdentifier(
				"d" + weatherBean.getFutureList().get(1).getWeather_id(),
				"drawable", "com.juhe.juheweather"));

		future_three.setText(weatherBean.getFutureList().get(2).getWeek());
		weather_future_three.setText(weatherBean.getFutureList().get(2)
				.getTemp());
		temp_future_three.setText(weatherBean.getFutureList().get(2).getDate());
		icon_future_three.setImageResource(getResources().getIdentifier(
				"d" + weatherBean.getFutureList().get(2).getWeather_id(),
				"drawable", "com.juhe.juheweather"));
	...
	private void setHoursWeatherBean(List<HoursWeatherBean> list) {
		...
		icon_hour_three.setImageResource(getResources().getIdentifier(
				"d" + list.get(0).getWeather_id(), "drawable",
				"com.juhe.juheweather"));

		hour_six.setText(list.get(1).getTime());
		weather_hour_six.setText(list.get(1).getTemp());
		icon_hour_six.setImageResource(getResources().getIdentifier(
				"d" + list.get(1).getWeather_id(), "drawable",
				"com.juhe.juheweather"));

		hour_nine.setText(list.get(2).getTime());
		weather_hour_nine.setText(list.get(2).getTemp());
		icon_hour_nine.setImageResource(getResources().getIdentifier(
				"d" + list.get(2).getWeather_id(), "drawable",
				"com.juhe.juheweather"));

		hour_tewle.setText(list.get(3).getTime());
		weather_hour_tewle.setText(list.get(3).getTemp());
		icon_hour_tewle.setImageResource(getResources().getIdentifier(
				"d" + list.get(3).getWeather_id(), "drawable",
				"com.juhe.juheweather"));

		hour_fifty.setText(list.get(4).getTime());
		weather_hour_fifty.setText(list.get(4).getTemp());
		icon_hour_fifty.setImageResource(getResources().getIdentifier(
				"d" + list.get(4).getWeather_id(), "drawable",
				"com.juhe.juheweather"));
	...
	private void readCity() { // 读取城市数据
		city = preferences.getString("city", "杭州");
		tv.setText(city);
